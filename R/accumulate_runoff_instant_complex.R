#' Apply iterative instantaneous velocity routing to a pre-processed complex
#' river network
#' 
#' A method for instantaneous runoff routing that takes a pre-processed HS river
...
#' Instantaneous routing is suitable for discharge aggregated to monthly or
#' longer time periods.
#'
...
#' @export
accumulate_runoff_instant_complex <- function(sf_river_network,
                                          riverID = "riverID",
