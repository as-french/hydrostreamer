...
contained in the package convering the extent of the Shannon system. GRUN data
...
translate gridded ECMWF ERA5 reanlaysis (or SEAS5 seasonal forecast, or CMIP
...
classified as a "simple" dendritic acyclic graph. A larger example dataset
...
`hydrostreamer::accumulate_runoff(routing_method = "instant")`,
`hydrostreamer::accumulate_runoff_constant_complex()`
...
habitat availability (e.g., for salmonids).
