...
The inefficent method does not split the network into topological groups.
...
insufficnet RAM. We provide example data for the Shannon catchment to
demonstrate that even the efficent method will take ~50 minutes to run after
...
# 50 seconds for 1 year of hourly time-step runoff for 832 river segments in
...
# 14 seconds for 1 year of daily time-step runoff for 832 river segments in
# Miera on standard laptop (2.10 GHz processor)
